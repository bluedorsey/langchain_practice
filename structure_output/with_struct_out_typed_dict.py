...
class Review (TypedDict):
    key_theme : Annotated[list[str],'Write down all the key theme reviewed in the list']
    ...
    sentiment:Annotated[Literal['+ve','-ve'],'Retrun the sentiment of review Positive or negative or neutral']
review_1='''
...
'''
review_2 = """
The hardware is greate , but the software feels bloated. There  are too many pre-installed app that I can't remove . Also , the UI look outdated compared to other brand . Hopingg for the software Update to fix this 
"""

structure_model= model.with_structured_output(Review)
result = structure_model.invoke(review_1)
print(result)

# data type or data validation is very less 